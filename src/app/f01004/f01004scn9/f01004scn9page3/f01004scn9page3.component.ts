...
@Component({
  selector: 'app-f01004scn9page3',
  templateUrl: './f01004scn9page3.component.html',
  styleUrls: ['./f01004scn9page3.component.css', '../../../../assets/css/f01.css']
})
export class F01004scn9page3Component implements OnInit {
