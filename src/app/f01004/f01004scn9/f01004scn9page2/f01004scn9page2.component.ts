...
@Component({
  selector: 'app-f01004scn9page2',
  templateUrl: './f01004scn9page2.component.html',
  styleUrls: ['./f01004scn9page2.component.css', '../../../../assets/css/f01.css']
})
export class F01004scn9page2Component implements OnInit {
