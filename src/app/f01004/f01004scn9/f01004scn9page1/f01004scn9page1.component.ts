...
@Component({
  selector: 'app-f01004scn9page1',
  templateUrl: './f01004scn9page1.component.html',
  styleUrls: ['./f01004scn9page1.component.css', '../../../../assets/css/f01.css']
})
export class F01004scn9page1Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private f01004scn9Service: F01004scn9Service) { }
  ...
  ngOnInit(): void {
    ...
    this.f01004scn9Service.getDate(url, formdata).subscribe(data => {
  ...
  getCoreCusInfo(dateValue: string) {
    ...
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'CORE_CUS_INFO');
    this.f01004scn9Service.getCoreCusInfo(formdata).subscribe(data => {
