...
@Component({
  selector: 'app-f01004scn12add',
  templateUrl: './f01004scn12add.component.html',
  styleUrls: ['./f01004scn12add.component.css']
})
export class F01004scn12addComponent implements OnInit {

  constructor(public dialogRef: MatDialogRef<F01004scn12addComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public f01004scn12Service: F01004scn12Service, public dialog: MatDialog) { }
