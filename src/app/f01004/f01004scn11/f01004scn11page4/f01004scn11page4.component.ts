...
@Component({
  selector: 'app-f01004scn11page4',
  templateUrl: './f01004scn11page4.component.html',
  styleUrls: ['./f01004scn11page4.component.css','../../../../assets/css/f01.css']
})
export class F01004scn11page4Component implements OnInit {
