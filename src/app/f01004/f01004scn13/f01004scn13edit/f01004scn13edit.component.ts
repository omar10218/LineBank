...
@Component({
  selector: 'app-f01004scn13edit',
  templateUrl: './f01004scn13edit.component.html',
  styleUrls: ['./f01004scn13edit.component.css']
})
export class F01004scn13editComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F01004scn13editComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public f01004scn13Service: F01004scn13Service, public dialog: MatDialog) {
  ...
  async uploadFile() {
    ...
    const baseUrl = 'f01/f01004scn13action2';
    if (this.files != null) {
      var mimeType = this.files.type;
      if (mimeType.match(/image\/*/) == null) {
        this.msg = "檔案非圖片類型!";
