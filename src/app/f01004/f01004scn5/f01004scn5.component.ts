...
import { F01004scn5Service } from './f01004scn5.service';
interface dateCode {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-f01004scn5',
  templateUrl: './f01004scn5.component.html',
  styleUrls: ['./f01004scn5.component.css','../../../assets/css/f01.css']
})
export class F01004scn5Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private router: Router, private f01004scn5Service: F01004scn5Service) { }
  ...
  getCustomerInfo(){
    ...
    this.f01004scn5Service.getCustomerInfoSearch(formdata).subscribe(data => {
