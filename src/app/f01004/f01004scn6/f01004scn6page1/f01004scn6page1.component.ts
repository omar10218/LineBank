...
@Component({
  selector: 'app-f01004scn6page1',
  templateUrl: './f01004scn6page1.component.html',
  styleUrls: ['./f01004scn6page1.component.css', '../../../../assets/css/f01.css']
})
export class F01004scn6page1Component implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private f01004scn6Service: F01004scn6Service, private router: Router) {
  ...
  getJcicMultiple() {
    ...
    this.f01004scn6Service.getMASTERJCICSearch(formdata).subscribe(data => {
  ...
  getKRI002() {
    ...
    this.f01004scn6Service.getJCICSearch(formdata).subscribe(data => {
