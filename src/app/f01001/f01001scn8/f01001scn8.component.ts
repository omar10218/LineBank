...
export class F01001scn8Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.f01001scn8Service.getSysTypeCode('CON_TEL', 'f01/f01001scn8')//電話種類下拉選單
      .subscribe(data => {
    ...
    this.f01001scn8Service.getSysTypeCode('CON_TARGET', 'f01/f01001scn8')//對象種類下拉選單
      .subscribe(data => {
        for (const jsonObj of data.rspBody) {
          const codeNo = jsonObj['codeNo'];
          const desc = jsonObj['codeDesc'];
    ...
    this.f01001scn8Service.getSysTypeCode('CON_MEMO', 'f01/f01001scn8')//註記種類下拉選單
      .subscribe(data => {
        for (const jsonObj of data.rspBody) {
          const codeNo = jsonObj['codeNo'];
          const desc = jsonObj['codeDesc'];
