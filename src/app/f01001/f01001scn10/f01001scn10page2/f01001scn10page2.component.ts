...
@Component({
  selector: 'app-f01001scn10page2',
  templateUrl: './f01001scn10page2.component.html',
  styleUrls: ['./f01001scn10page2.component.css', '../../../../assets/css/f01.css']
})
export class F01001scn10page2Component implements OnInit, AfterViewInit {
  ...
  DSS2Source = new MatTableDataSource<any>();

  ngAfterViewInit(): void {
    this.getDSS2(this.queryDate);
  ...
  getDSS2(dateValue: string) {
    ...
    this.f01001scn10Service.getDSSSearch(formdata).subscribe(data => {
      ...
      this.DSS2Source.data = data.rspBody.items;
    });
  }
