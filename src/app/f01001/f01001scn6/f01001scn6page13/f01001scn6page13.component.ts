...
@Component({
  selector: 'app-f01001scn6page13',
  templateUrl: './f01001scn6page13.component.html',
  styleUrls: ['./f01001scn6page13.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page13Component implements OnInit, AfterViewInit {
