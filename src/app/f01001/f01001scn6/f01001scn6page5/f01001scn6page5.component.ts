...
@Component({
  selector: 'app-f01001scn6page5',
  templateUrl: './f01001scn6page5.component.html',
  styleUrls: ['./f01001scn6page5.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page5Component implements OnInit, AfterViewInit {
