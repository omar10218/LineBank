...
@Component({
  selector: 'app-f01001scn6page4',
  templateUrl: './f01001scn6page4.component.html',
  styleUrls: ['./f01001scn6page4.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page4Component implements OnInit, AfterViewInit {
  ...
  BAI001Source = new MatTableDataSource<any>();
  ...
  getBAI001(){
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAI001Source.data = data.rspBody.items;
    });
  }
}
