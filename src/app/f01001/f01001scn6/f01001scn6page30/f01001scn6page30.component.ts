...
@Component({
  selector: 'app-f01001scn6page30',
  templateUrl: './f01001scn6page30.component.html',
  styleUrls: ['./f01001scn6page30.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page30Component implements OnInit {
