...
@Component({
  selector: 'app-f01001scn6page17',
  templateUrl: './f01001scn6page17.component.html',
  styleUrls: ['./f01001scn6page17.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page17Component implements OnInit {
  ...
  BAM306Source = new MatTableDataSource<any>();
  ...
  getBAM306() {
    ...
    console.log("代碼=BAM306");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'BAM306');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM306Source.data = data.rspBody.items;
    });
  }
