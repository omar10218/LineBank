...
@Component({
  selector: 'app-f01001scn6page26',
  templateUrl: './f01001scn6page26.component.html',
  styleUrls: ['./f01001scn6page26.component.css', '../../../../assets/css/f01.css']
})
export class F01001scn6page26Component implements OnInit, AfterViewInit {
  ...
  DAM001Source = new MatTableDataSource<any>();
  ...
  getDAM001() {
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.DAM001Source.data = data.rspBody.items;
    });
  }
}
