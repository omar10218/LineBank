...
@Component({
  selector: 'app-f01001scn6page40',
  templateUrl: './f01001scn6page40.component.html',
  styleUrls: ['./f01001scn6page40.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page40Component implements OnInit {
  ...
  STM025Source = new MatTableDataSource<any>();
  ...
  getSTM025() {
    ...
    console.log("代碼=STM025");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'STM025');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.STM025Source.data = data.rspBody.items;
    });
  }
