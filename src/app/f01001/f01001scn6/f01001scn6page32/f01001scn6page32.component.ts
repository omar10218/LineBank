...
@Component({
  selector: 'app-f01001scn6page32',
  templateUrl: './f01001scn6page32.component.html',
  styleUrls: ['./f01001scn6page32.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page32Component implements OnInit {
  ...
  JAS002Source = new MatTableDataSource<any>();
  ...
  getJAS002() {
    ...
    console.log("代碼=JAS002");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'JAS002');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.JAS002Source.data = data.rspBody.items;
    });
  }
