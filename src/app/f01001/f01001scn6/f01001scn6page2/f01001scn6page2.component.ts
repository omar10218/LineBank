...
@Component({
  selector: 'app-f01001scn6page2',
  templateUrl: './f01001scn6page2.component.html',
  styleUrls: ['./f01001scn6page2.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page2Component implements OnInit, AfterViewInit {
  ...
  APS001Source = new MatTableDataSource<any>();
  ...
  getAPS001(){
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.APS001Source.data = data.rspBody.items;
    });
  }
}
