...
@Component({
  selector: 'app-f01001scn6page37',
  templateUrl: './f01001scn6page37.component.html',
  styleUrls: ['./f01001scn6page37.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page37Component implements OnInit {
  ...
  VAM201Source = new MatTableDataSource<any>();
  ...
  getVAM201() {
    ...
    console.log("代碼=VAM201");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'VAM201');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.VAM201Source.data = data.rspBody.items;
    });
  }
