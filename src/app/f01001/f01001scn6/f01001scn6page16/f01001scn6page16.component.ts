...
@Component({
  selector: 'app-f01001scn6page16',
  templateUrl: './f01001scn6page16.component.html',
  styleUrls: ['./f01001scn6page16.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page16Component implements OnInit {
  ...
  BAM305Source = new MatTableDataSource<any>();
  ...
  getBAM305() {
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM305Source.data = data.rspBody.items;
    });
  }
