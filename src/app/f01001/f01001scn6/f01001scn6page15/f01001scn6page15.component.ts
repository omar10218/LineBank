...
@Component({
  selector: 'app-f01001scn6page15',
  templateUrl: './f01001scn6page15.component.html',
  styleUrls: ['./f01001scn6page15.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page15Component implements OnInit {
  ...
  BAM101Source = new MatTableDataSource<any>();
  ...
  getBAM101() {
    ...
    console.log("代碼=BAM101");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'BAM101');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM101Source.data = data.rspBody.items;
    });
  }
