...
@Component({
  selector: 'app-f01001scn6page3',
  templateUrl: './f01001scn6page3.component.html',
  styleUrls: ['./f01001scn6page3.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page3Component implements OnInit, AfterViewInit {
  ...
  ACI001Source = new MatTableDataSource<any>();
  ...
  getACI001(){
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.ACI001Source.data = data.rspBody.items;
    });
  }
}
