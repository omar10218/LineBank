...
@Component({
  selector: 'app-f01001scn6page18',
  templateUrl: './f01001scn6page18.component.html',
  styleUrls: ['./f01001scn6page18.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page18Component implements OnInit {
  ...
  BAM307Source = new MatTableDataSource<any>();
  ...
  getBAM307() {
    ...
    console.log("代碼=BAM307");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'BAM307');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM307Source.data = data.rspBody.items;
    });
  }
