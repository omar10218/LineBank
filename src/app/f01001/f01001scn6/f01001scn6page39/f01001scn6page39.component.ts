...
@Component({
  selector: 'app-f01001scn6page39',
  templateUrl: './f01001scn6page39.component.html',
  styleUrls: ['./f01001scn6page39.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page39Component implements OnInit {
  ...
  STM008Source = new MatTableDataSource<any>();
  ...
  getSTM008() {
    ...
    console.log("代碼=STM008");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'STM008');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.STM008Source.data = data.rspBody.items;
    });
  }
