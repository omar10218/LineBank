...
@Component({
  selector: 'app-f01001scn6page36',
  templateUrl: './f01001scn6page36.component.html',
  styleUrls: ['./f01001scn6page36.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page36Component implements OnInit {
  ...
  VAM108Source = new MatTableDataSource<any>();
  ...
  getVAM108() {
    ...
    console.log("代碼=VAM108");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'VAM108');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.VAM108Source.data = data.rspBody.items;
    });
  }
