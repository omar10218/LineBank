...
@Component({
  selector: 'app-f01001scn6page11',
  templateUrl: './f01001scn6page11.component.html',
  styleUrls: ['./f01001scn6page11.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page11Component implements OnInit, AfterViewInit {
  ...
  BAM029Source = new MatTableDataSource<any>();
  ...
  getBAM029(){
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM029Source.data = data.rspBody.items;
    });
  }
}
