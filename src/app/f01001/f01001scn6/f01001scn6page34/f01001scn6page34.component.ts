...
@Component({
  selector: 'app-f01001scn6page34',
  templateUrl: './f01001scn6page34.component.html',
  styleUrls: ['./f01001scn6page34.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page34Component implements OnInit {
  ...
  VAM106Source = new MatTableDataSource<any>();
  ...
  getVAM106() {
    ...
    console.log("代碼=VAM106");
    console.log("ID="+this.cuid);
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'VAM106');
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.VAM106Source.data = data.rspBody.items;
    });
  }
