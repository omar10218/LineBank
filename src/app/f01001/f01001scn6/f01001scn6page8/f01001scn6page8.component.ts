...
@Component({
  selector: 'app-f01001scn6page8',
  templateUrl: './f01001scn6page8.component.html',
  styleUrls: ['./f01001scn6page8.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page8Component implements OnInit, AfterViewInit {
  ...
  BAM070Source = new MatTableDataSource<any>();
  ...
  getBAM070(){
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM070Source.data = data.rspBody.items;
    });
  }
}
