...
@Component({
  selector: 'app-f01001scn6page12',
  templateUrl: './f01001scn6page12.component.html',
  styleUrls: ['./f01001scn6page12.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page12Component implements OnInit, AfterViewInit {
