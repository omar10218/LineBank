...
@Component({
  selector: 'app-f01001scn6page19',
  templateUrl: './f01001scn6page19.component.html',
  styleUrls: ['./f01001scn6page19.component.css','../../../../assets/css/f01.css']
})
export class F01001scn6page19Component implements OnInit, AfterViewInit {
  ...
  BAM421Source = new MatTableDataSource<any>();
  ngAfterViewInit() {
    this.getBAM421();
  ...
  getBAM421() {
    ...
    this.f01001scn6Service.getJCICSearch(formdata).subscribe(data => {
      ...
      this.BAM421Source.data = data.rspBody.items;
    });
  }
}
