...
export class F03016Component implements OnInit {
	...
	getImpertmentParameterInfo() {
		...
		this.f03016Service.getImpertmentParameter(baseUrl, this.currentPage.pageIndex, this.currentPage.pageSize).subscribe(data => {
			...
			this.CssPassStart = new Date(data.rspBody.ipList[0].cssPassStart)
			this.CssPassEnd = new Date(data.rspBody.ipList[0].cssPassEnd)
    ...
    console.log(this.CssPassStart < this.CssPassEnd, this.CssPassStart != null , this.CssPassEnd != null)
	...
	onChange(result: Date): void {
		// this.pipe.transform(new Date(result), 'yyyy/MM/dd');
  ...
  onQueryParamsChange(params: NzTableQueryParams): void {
    ...
    this.currentPage.pageIndex=params.pageIndex;
    this.currentPage.pageSize=params.pageSize;
    this.getImpertmentParameterInfo();
  }
