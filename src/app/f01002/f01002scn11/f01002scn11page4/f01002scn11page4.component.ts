...
@Component({
  selector: 'app-f01002scn11page4',
  templateUrl: './f01002scn11page4.component.html',
  styleUrls: ['./f01002scn11page4.component.css','../../../../assets/css/f01.css']
})
export class F01002scn11page4Component implements OnInit {
