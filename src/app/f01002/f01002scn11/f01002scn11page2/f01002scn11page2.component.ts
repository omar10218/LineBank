...
@Component({
  selector: 'app-f01002scn11page2',
  templateUrl: './f01002scn11page2.component.html',
  styleUrls: ['./f01002scn11page2.component.css', '../../../../assets/css/f01.css']
})
export class F01002scn11page2Component implements OnInit {
