...
@Component({
  selector: 'app-f01002scn9page1',
  templateUrl: './f01002scn9page1.component.html',
  styleUrls: ['./f01002scn9page1.component.css', '../../../../assets/css/f01.css']
})
export class F01002scn9page1Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.f01002scn9Service.getDate(url, formdata).subscribe(data => {
