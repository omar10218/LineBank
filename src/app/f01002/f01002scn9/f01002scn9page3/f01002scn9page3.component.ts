...
@Component({
  selector: 'app-f01002scn9page3',
  templateUrl: './f01002scn9page3.component.html',
  styleUrls: ['./f01002scn9page3.component.css', '../../../../assets/css/f01.css']
})
export class F01002scn9page3Component implements OnInit {
