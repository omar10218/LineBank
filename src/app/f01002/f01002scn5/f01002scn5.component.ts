...
import { F01002scn5Service } from './f01002scn5.service';
interface dateCode {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-f01002scn5',
  templateUrl: './f01002scn5.component.html',
  styleUrls: ['./f01002scn5.component.css','../../../assets/css/f01.css']
})
export class F01002scn5Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private router: Router, private f01002scn5Service: F01002scn5Service) { }
  ...
  getCustomerInfo(){
    ...
    this.f01002scn5Service.getCustomerInfoSearch(formdata).subscribe(data => {
