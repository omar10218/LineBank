...
import { F01002scn10Service } from '../f01002scn10.service';
interface dateCode {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-f01002scn10page1',
  templateUrl: './f01002scn10page1.component.html',
  styleUrls: ['./f01002scn10page1.component.css', '../../../../assets/css/f01.css']
})
export class F01002scn10page1Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private f01002scn10Service: F01002scn10Service) { }
  ...
  ngOnInit(): void {
    ...
    const url = 'f01/f01002scn10';
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'DSS1');
    this.f01002scn10Service.getDate(url, formdata).subscribe(data => {
  ...
  getDSS1(dateValue: string) {
    ...
    this.f01002scn10Service.getDSSSearch(formdata).subscribe(data => {
