...
@Component({
  selector: 'app-f01002scn13edit',
  templateUrl: './f01002scn13edit.component.html',
  styleUrls: ['./f01002scn13edit.component.css']
})
export class F01002scn13editComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F01002scn13editComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public f01002scn13Service: F01002scn13Service, public dialog: MatDialog) {
  ...
  async uploadFile() {
    ...
    const baseUrl = 'f01/f01002scn13action2';
    if (this.files != null) {
      var mimeType = this.files.type;
      if (mimeType.match(/image\/*/) == null) {
        this.msg = "檔案非圖片類型!";
