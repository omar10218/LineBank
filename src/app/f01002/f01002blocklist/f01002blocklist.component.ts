...
export class F01002blocklistComponent implements OnInit {
  ...
  constructor(
    ...
    private blockListService: F01002BlockListService,
    public childService: ChildrenService,
    public dialogRef: MatDialogRef<F01002blocklistComponent>,
  ...
  ngOnInit(): void {
    ...
    //取下拉選單資料
    this.blockListService.getSysTypeCode('BK_REASON')//通報原因下拉選單
      .subscribe(data => {
