...
@Component({
  selector: 'app-f01003scn13add',
  templateUrl: './f01003scn13add.component.html',
  styleUrls: ['./f01003scn13add.component.css']
})
export class F01003scn13addComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<F01003scn13addComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public f01003scn13Service: F01003scn13Service, public dialog: MatDialog) {
  ...
  async uploadFile() {
    if (this.files != null) {
      ...
      if (mimeType.match(/image\/*/) == null) {
        ...
        const baseUrl = 'f01/f01003scn13action1';
        let msgStr: string = "";
        let codeStr: string = "";
