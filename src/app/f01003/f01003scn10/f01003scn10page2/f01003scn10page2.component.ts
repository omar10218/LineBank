...
import { F01003scn10Service } from '../f01003scn10.service';
interface dateCode {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-f01003scn10page2',
  templateUrl: './f01003scn10page2.component.html',
  styleUrls: ['./f01003scn10page2.component.css', '../../../../assets/css/f01.css']
})
export class F01003scn10page2Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private f01003scn10Service: F01003scn10Service) { }
  ...
  ngOnInit(): void {
    ...
    const url = 'f01/f01003scn10';
    const formdata: FormData = new FormData();
    formdata.append('applno', this.applno);
    formdata.append('cuid', this.cuid);
    formdata.append('code', 'DSS2');
    this.f01003scn10Service.getDate(url, formdata).subscribe(data => {
  ...
  getDSS2(dateValue: string) {
    ...
    this.f01003scn10Service.getDSSSearch(formdata).subscribe(data => {
