...
@Component({
  selector: 'app-f01003scn11page1',
  templateUrl: './f01003scn11page1.component.html',
  styleUrls: ['./f01003scn11page1.component.css', '../../../../assets/css/f01.css']
})
export class F01003scn11page1Component implements OnInit {
