...
@Component({
  selector: 'app-f01003scn11page5',
  templateUrl: './f01003scn11page5.component.html',
  styleUrls: ['./f01003scn11page5.component.css', '../../../../assets/css/f01.css']
})
export class F01003scn11page5Component implements OnInit {
