...
@Component({
  selector: 'app-f01003scn11page3',
  templateUrl: './f01003scn11page3.component.html',
  styleUrls: ['./f01003scn11page3.component.css','../../../../assets/css/f01.css']
})
export class F01003scn11page3Component implements OnInit {
