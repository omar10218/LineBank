...
import { F01003scn5Service } from './f01003scn5.service';
interface dateCode {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-f01003scn5',
  templateUrl: './f01003scn5.component.html',
  styleUrls: ['./f01003scn5.component.css','../../../assets/css/f01.css']
})
export class F01003scn5Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private router: Router, private f01003scn5Service: F01003scn5Service) { }
  ...
  getCustomerInfo(){
    ...
    this.f01003scn5Service.getCustomerInfoSearch(formdata).subscribe(data => {
