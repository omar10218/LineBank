...
@Component({
  selector: 'app-f01003scn6page1',
  templateUrl: './f01003scn6page1.component.html',
  styleUrls: ['./f01003scn6page1.component.css', '../../../../assets/css/f01.css']
})
export class F01003scn6page1Component implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private f01003scn6Service: F01003scn6Service, private router: Router) {
  ...
  getJcicMultiple() {
    ...
    this.f01003scn6Service.getMASTERJCICSearch(formdata).subscribe(data => {
  ...
  getKRI002() {
    ...
    this.f01003scn6Service.getJCICSearch(formdata).subscribe(data => {
