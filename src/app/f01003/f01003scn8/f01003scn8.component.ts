...
import { F01003scn8addComponent } from './f01003scn8add/f01003scn8add.component';
import { F01003scn8confirmComponent } from './f01003scn8confirm/f01003scn8confirm.component';
import { F01003scn8editComponent } from './f01003scn8edit/f01003scn8edit.component';
interface sysCode {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-f01003scn8',
  templateUrl: './f01003scn8.component.html',
  styleUrls: ['./f01003scn8.component.css', '../../../assets/css/f01.css']
})
export class F01003scn8Component implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: ActivatedRoute, private router: Router, public dialog: MatDialog, private f01003scn8Service: F01003scn8Service) { }
  ...
  Add() {
    const dialogRef = this.dialog.open(F01003scn8addComponent, {
      minHeight: '100vh',
      width: '50%',
      data: {
        applno: this.applno,
  ...
  startEdit(CON_TEL: string, PHONE: string, CON_TARGET: string, CUST_TYPE: string, CON_MEMO: string, NOTE: string, ID: string) {
    const dialogRef = this.dialog.open(F01003scn8editComponent, {
      minHeight: '100vh',
      width: '50%',
      data: {
        con_TEL: CON_TEL,
  ...
  delete(ID: string) {
    let msg = '';
    const url = 'f01/f01003scn8action3';
    this.f01003scn8Service.DeleteCALLOUT(url, ID).subscribe(data => {
      msg = data.rspMsg;
    });
    setTimeout(() => {
      const DialogRef = this.dialog.open(F01003scn8confirmComponent, { data: { msgStr: msg } });
  ...
  private async getCALLOUTFunction() {
    const baseUrl = 'f01/f01003scn8scn1';
    this.f01003scn8Service.getCALLOUT(baseUrl, this.currentPage.pageIndex, this.currentPage.pageSize, this.applno).subscribe(data => {
  ...
  ShowspeakingContenta(speakingContent: string): void {
    const DialogRef = this.dialog.open(F01003scn8confirmComponent, { data: { msgStr: speakingContent } });
