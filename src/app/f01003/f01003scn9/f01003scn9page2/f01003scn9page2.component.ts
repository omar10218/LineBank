...
@Component({
  selector: 'app-f01003scn9page2',
  templateUrl: './f01003scn9page2.component.html',
  styleUrls: ['./f01003scn9page2.component.css', '../../../../assets/css/f01.css']
})
export class F01003scn9page2Component implements OnInit {
