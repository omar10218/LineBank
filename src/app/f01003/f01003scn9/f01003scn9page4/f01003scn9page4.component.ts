...
@Component({
  selector: 'app-f01003scn9page4',
  templateUrl: './f01003scn9page4.component.html',
  styleUrls: ['./f01003scn9page4.component.css', '../../../../assets/css/f01.css']
})
export class F01003scn9page4Component implements OnInit {
